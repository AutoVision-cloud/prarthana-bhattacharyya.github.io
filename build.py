...
def get_personal_data():
    ...
    email = "dr.prarthana.bhattacharyya@gmail.com"
    twitter = "prarthana_bh"
    github = "AutoVision-cloud"
    linkedin = "prarthana-bhattacharyya"
    bio_text = f"""
                <p>I am a machine learning researcher at Ultraleap in Bristol, working on 3D computer vision.
                </p>
                <p>
                    <span style="font-weight: bold;">Bio:</span>
                    I studied Electrical and Computer Engineering at University of Waterloo, where I earned my Ph.D. under the supervision of <a href="https://scholar.google.com/citations?hl=en&user=ZzCpumQAAAAJ&view_op=list_works" target="_blank"> Krzysztof Czarnecki, where I was working on safe and game theoretic motion planning for autonomous driving and autonomous racing. 
                </p>
                <p>
